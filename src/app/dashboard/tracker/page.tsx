      ...
      <AnimatePresence>
        ...
        {isRefineModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div variants={modalVariants} initial="hidden" animate="visible" exit="exit" className="glass-card w-full max-w-md p-6 sm:p-8 relative z-10 border-white/20 shadow-2xl bg-surface/90">
              <div className="flex justify-between items-center mb-6">
